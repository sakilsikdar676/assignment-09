      ...
      <div className="sticky top-0 z-50 z-10 mx-auto max-w-7xl px-4 py-4 md:px-8">
        <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-5 py-4 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.37)]">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <NavLink href="/cars">Explore Cars</NavLink>
...
function DropdownItem({ href, children, icon }) {
  return (
    <Link
      href={href}
      className="flex items-center gap-3 rounded-2xl px-4 py-3 text-sm text-gray-200 transition hover:bg-white/10 hover:text-lime-400"
    >
      {icon}
      {children}
    </Link>
