...
const AuthPage = () => {
  ...
  return (
    <div
      ...
      style={{
        // ১. পুরো পেজের মেইন ব্যাকগ্রাউন্ড ইমেজ এখানে বসাবে
        backgroundImage: `url('https://cdn.pixabay.com/photo/2024/08/19/10/15/ai-generated-8980377_1280.jpg')`,
      }}
    >
      {/* Dark Overlay জেনারেট করা ছবির মতো ডার্ক ভাইব আনার জন্য */}
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/40 border border-white/10 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-md">
        ...
        <div className="w-full h-44 relative overflow-hidden">
          ...
          />
          {/* ইমেজ থেকে নিচের ফর্মে স্মুথলি ব্লেন্ড হওয়ার জন্য গ্রেডিয়েন্ট শেড */}
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <button className="w-full py-4 bg-gradient-to-r from-emerald-400 to-teal-500 hover:from-emerald-500 hover:to-teal-600 text-slate-950 font-bold rounded-2xl transition duration-200 active:scale-[0.98] shadow-[0_0_25px_rgba(52,211,153,0.2)]">
            LogIn
          </button>
          ...
          <div className="">
            {/* Google */}
            <button className="w-full flex items-center justify-center gap-2.5 py-3 bg-slate-950/40 hover:bg-slate-950/80 border border-gray-800 rounded-xl text-sm font-medium text-white transition active:scale-95">
