  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        <div className="fixed inset-0 z-100 isolate flex items-start  justify-center bg-black/60 backdrop-blur-lg p-4  ">
          <div className="relative w-full max-w-4xl rounded-2xl border border-white/10 bg-[#0D2342] px-5 py-4 backdrop-blur-2xl shadow-2xl text-white">
            ...
            {/* ফর্ম বডি */}
            <form onSubmit={handleFormSubmit} className="flex flex-col gap-4 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Sports" className="bg-[#0A192F]">Sports</option>
                    <option value="Van" className="bg-[#0A192F]">Van</option>
                    <option value="Convertible" className="bg-[#0A192F]">Convertible</option>
                    <option value="Hybrid" className="bg-[#0A192F]">Hybrid</option>
                    <option value="Truck" className="bg-[#0A192F]">Truck</option>
                  </select>
                </div>
